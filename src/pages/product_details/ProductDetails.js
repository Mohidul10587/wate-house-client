...
const ProductDetails = () => {
  ...
  const { data: product, isLoading } = useQuery('product', () => fetch(`https://mohid-shop.onrender.com/product/${productId}`).then(res => res.json()))
  ...
  const addToCart = () => {
    ...
    fetch(`https://mohid-shop.onrender.com/cart/${user.email}`, {
      method: 'POST',
      headers: {
